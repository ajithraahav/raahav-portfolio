...
export const EngineeringShowcase: React.FC = () => {
  ...
  const architectureLayers = [
    {
      ...
      color: "border-[#0071E3] text-[#0071E3] bg-[#0071E3]/10"
    },
    {
  ...
  return (
    <section id="engineering" className="py-24 relative bg-[#F5F5F7]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-16">
          ...
          <div className="lg:col-span-6 space-y-3">
            <div className="text-xs font-mono text-[#86868B] uppercase tracking-wider mb-2 flex items-center gap-2 font-semibold">
              <Layers className="w-4 h-4 text-[#0071E3]" /> Clean Architecture Pipeline (Click to Inspect)
            </div>
              ...
              <div
                ...
                className={`p-4 rounded-2xl border transition-all duration-200 cursor-pointer flex items-center justify-between ${
                  selectedNode === idx
                    ...
                    : 'bg-white border-black/5 text-[#1D1D1F] hover:border-[#0071E3]/30'
                }`}
              >
                <div>
                  <div className="font-mono text-xs font-bold uppercase tracking-wider">{layer.name}</div>
                  <div className="text-base font-bold text-[#1D1D1F] mt-0.5">{layer.subtitle}</div>
                </div>
                <ArrowRight className={`w-5 h-5 ${selectedNode === idx ? 'text-[#0071E3]' : 'text-[#86868B]'}`} />
              </div>
            ))}
          </div>
          ...
          <div className="lg:col-span-6">
            <div className="apple-glass-card rounded-3xl p-6 sm:p-8 relative min-h-[380px] flex flex-col justify-between">
              
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F5F5F7] border border-black/5 text-[#0071E3] font-mono text-xs font-bold mb-4">
              ...
              <div className="pt-4 border-t border-black/5">
                <div className="text-xs font-mono text-[#86868B] uppercase tracking-wider mb-3 font-semibold">
                ...
                <div className="flex flex-wrap gap-2">
                  {architectureLayers[selectedNode].tech.map((t) => (
                    <span
                      key={t}
                      className="px-3.5 py-1 rounded-full bg-[#F5F5F7] border border-black/5 font-mono text-xs text-[#0071E3] font-bold shadow-2xs"
                    >
                      {t}
                    </span>
                  ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="apple-glass-card rounded-2xl p-6">
            <div className="p-3 rounded-2xl bg-[#0071E3]/10 text-[#0071E3] w-fit mb-4">
              <RefreshCw className="w-5 h-5" />
            </div>
            <h4 className="text-base font-bold text-[#1D1D1F] mb-2">Exponential Backoff</h4>
          ...
          <div className="apple-glass-card rounded-2xl p-6">
            ...
            <h4 className="text-base font-bold text-[#1D1D1F] mb-2">Offline-First Sync</h4>
            <p className="text-xs text-[#515154] leading-relaxed">
          ...
          <div className="apple-glass-card rounded-2xl p-6">
            <div className="p-3 rounded-2xl bg-amber-50 text-amber-700 w-fit mb-4">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <h4 className="text-base font-bold text-[#1D1D1F] mb-2">HIPAA Data Security</h4>
            <p className="text-xs text-[#515154] leading-relaxed">
          ...
          <div className="apple-glass-card rounded-2xl p-6">
            ...
            <h4 className="text-base font-bold text-[#1D1D1F] mb-2">60 FPS Tuning</h4>
            <p className="text-xs text-[#515154] leading-relaxed">
